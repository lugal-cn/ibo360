...
$lang = array
(
	'grouplist_gtids' => '博物馆小站类别',
	'grouplist_gtids_comment' => '选择博物馆小站类别',
	'grouplist_fids' => '指定博物馆小站',
	'grouplist_fids_comment' => '输入指定博物馆小站的ID，多个ID之间用逗号分隔',
	'grouplist_startrow' => '起始数据行数',
	'grouplist_startrow_comment' => '如需设定起始的数据行数，请输入具体数值，0 为从第一行开始，以此类推',
	'grouplist_titlelength' => '名称长度',
	'grouplist_titlelength' => '设置博物馆小站名称最大长度',
	'grouplist_summarylength' => '介绍长度',
	'grouplist_summarylength_comment' => '设置博物馆小站介绍最大长度',
	'grouplist_orderby' => '博物馆小站排序方式',
	'grouplist_orderby_comment' => '设置以哪一字段或方式对博物馆小站进行排序',
