...
$lang = array (
  ...
  'group_nonexist' => '博物馆小站不存在',
  'grouptype_delete_sub_notnull' => '存在下级分类，请先返回删除本分类或分类的下级博物馆小站',
  ...
  'counter_groupmember_num_succeed' => '博物馆小站成员数重建完成',
  'counter_groupmember_post_succeed' => '博物馆小站成员发帖数重建完成',
  'counter_groupnum_succeed' => '分类博物馆小站数重建完成',
  ...
  'group_status_off' => '请先开启博物馆小站功能，现在转到博物馆小站设置页',
  'group_update_succeed' => '博物馆小站分类设置更新成功 ',
  'grouptype_delete_succeed' => '博物馆小站分类删除成功 ',
  'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中帖子和附件吗？<br />注意：删除博物馆小站并不会更新用户发帖数和积分',
  'grouptype_delete_alarm' => '本操作不可恢复，正在删除博物馆小站数据...',
  'group_name_exist' => '该博物馆小站名称已经存在',
  'group_edit_succeed' => '博物馆小站编辑成功 ',
  'group_thread_removing' => '正在删除博物馆小站内的帖子，请勿关闭浏览器！',
  'group_delete_succeed' => '博物馆小站删除成功 ',
  'group_changetype_succeed' => '博物馆小站分类调整成功 ',
  'group_merge_continue' => '正在合并第{m}个博物馆小站，还有{n}个，请勿关闭浏览器！',
  'group_mergegroup_succeed' => '博物馆小站合并成功 ',
  'group_optype_no_choice' => '没有选择操作类型',
  'group_newtypeid_no_choice' => '没有选择博物馆小站分类',
  'group_targetgroup_no_choice' => '没有填写目标博物馆小站ID',
  'group_targetgroup_repeat' => '目标博物馆小站与被合并博物馆小站重复',
  'group_targetid_error' => '目标ID错误',
  'group_delete_confirm' => '删除博物馆小站操作不可恢复，确认要删除吗？',
  'group_changetype_confirm' => '确认要将所选博物馆小站移动到分类 <font class="highlight">[{targetname}]</font> 下吗？',
  'group_mergegroup_confirm' => '合并博物馆小站操作不可恢复，确认要合并到博物馆小站 <font class="highlight">[{targetname}]</font> 吗？',
  'group_group_no_choice' => '没有选择要操作的博物馆小站',
  'group_userperm_succeed' => '操作成功 ',
  'group_level_update_credits_invalid' => '缺少积分下限为负数或 0 的博物馆小站等级',
  'group_level_update_credits_duplicate' => '博物馆小站等级积分下限设置重复',
  'group_level_succeed_except_all_levels' => '操作失败，不允许删除除所有的博物馆小站等级',
  'group_level_update_succeed' => '博物馆小站等级更新成功。如您添加了新的等级，<br />请不要忘记修改其相应的设置',
  'group_level_noexist' => '博物馆小站等级不存在',
  'group_mergetype_confirm' => '合并博物馆小站操作不可恢复，确认要合并吗？',
  'group_mergetype_target_error' => '目标分类错误',
  'group_mergetype_succeed' => '分类合并成功 ',
  'group_mod_succeed' => '博物馆小站审核成功 ',
