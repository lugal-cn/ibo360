...
(
	...
	'group_member_join' => '{actor} 加入您的 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> 博物馆小站需要审核，请到博物馆小站<a href="{url}" target="_blank">管理后台</a> 进行审核',
	'group_member_invite' => '{actor} 邀请您加入 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> 博物馆小站，<a href="{url}" target="_blank">点此马上加入</a>',
	'group_member_check' => '您已通过了 <a href="{url}" target="_blank">{groupname}</a> 博物馆小站的审核，请 <a href="{url}" target="_blank">点击这里访问</a>',
	'group_member_check_failed' => '您没有通过 <a href="{url}" target="_blank">{groupname}</a> 博物馆小站的审核。',
	'group_mod_check' => '您的创建的博物馆小站 <a href="{url}" target="_blank">{groupname}</a> 审核通过了，请 <a href="{url}" target="_blank">点击这里访问</a>',
...
<p class="summary">订单号：<span>{orderid}</span></p><p class="summary">支出：<span>人民币 {price} 元</span></p><p class="summary">收入：<span>{value}</span></p>',
	...
	'grouplevel_update' => '恭喜您，您的博物馆小站 {groupname} 已升级到 {newlevel}。',
