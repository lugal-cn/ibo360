...
$pick_config = array(
	...
	'time_out' => 10,//超时时间
	'max_redirs' => 2,
	'title_length' => 80,//标题截取长度，默认是80，有些用户有特殊需求，可以适当修改，但一定不能大于255
	...
	'thread_htmlon' => 0,//主题是否开启html ，如果开启，发布到论坛的代码将不转换成ubb代码。仅限discuz X3以上版本才能打开
	'reply_htmlon' => 0,//回复是否开启html
);
$pick_config['title_length'] = $pick_config['title_length'] ? $pick_config['title_length'] : 80;
$evo_rules = array(
